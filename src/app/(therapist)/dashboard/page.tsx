...
/**
 * SPRINT 1 — Dashboard del terapeuta.
 * Muestra resumen de pacientes y accesos rápidos.
 * Las funcionalidades completas (análisis de casos, patrones) se agregan en Sprint 4.
 */
